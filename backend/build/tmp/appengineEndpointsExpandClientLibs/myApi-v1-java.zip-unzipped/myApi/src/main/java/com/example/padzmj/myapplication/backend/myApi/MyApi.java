 ...
 * on 2016-08-09 at 23:15:39 UTC 
 * Modify at your own risk.
 */

package com.example.padzmj.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://jokecenter-1470428782810.appspot.com/_ah/api/";
  ...
  public class GetJoke extends MyApiRequest<com.example.padzmj.myapplication.backend.myApi.model.MyBean> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.padzmj.myapplication.backend.myApi.model.MyBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.example.padzmj.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.padzmj.myapplication.backend.myApi.model.MyBean.class);
